...
import pandas as pd
test  = pd.read_csv("https://raw.githubusercontent.com/alpgulden/data/master/train.csv")
train = pd.read_csv("https://raw.githubusercontent.com/alpgulden/data/master/test.csv")
...
train = pd.read_csv("https://raw.githubusercontent.com/alpgulden/data/master/train.csv")
test = pd.read_csv("https://raw.githubusercontent.com/alpgulden/data/master/test.csv")
print('Train Data', train.shape,' ', train.columns)
print('Test Data', test.shape)

print('Train labels', train['Activity'].unique(), 'Test Labels', test['Activity'].unique())
...
train_df = pd.read_csv("https://raw.githubusercontent.com/alpgulden/data/master/train.csv")
test_df = pd.read_csv("https://raw.githubusercontent.com/alpgulden/data/master/test.csv")
train_df.columns

#identifying the unique activities
unique_activities = train_df.Activity.unique()
print("NUmber of unique activities: {}".format(len(unique_activities)))
replacer = {}

# assign each activity a number. this is same as encoding. we are using a different technique for the same problem.
...
X_train, X_test, y_train, y_test = LoadAllData() #generating the training set
